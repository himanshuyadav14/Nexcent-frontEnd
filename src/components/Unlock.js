...
const Unlock = () => {
  return (
    <div className="w-[1440px] h-[433px] pt-16 mx-auto dark:bg-[#263238]">
      <div className="flex justify-evenly items-center ">
        ...
        <div>
          <div className="w-[601px] h-[184px]">
            <div className="font-semibold text-[36px] leading-[44px] text-[#4d4d4d] mt-[-160px] dark:text-white">
              The unseen of spending three years at Pixelgrade
            </div>
            <div className="font-normal text-[14px] leading-[20px] text-[#717171] mt-8 dark:text-white">
